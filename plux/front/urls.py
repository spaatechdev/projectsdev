...
urlpatterns = [
    ...
    path('downloadCustomerExcel', views.downloadCustomerExcel,
         name='downloadCustomerExcel'),
    ...
    path('salespersonDelete/<int:id>',
         views.salespersonDelete, name='salespersonDelete'),
    path('salespersonImport', views.salespersonImport, name='salespersonImport'),
    path('downloadSalespersonExcel', views.downloadSalespersonExcel,
         name='downloadSalespersonExcel'),
    ...
    path('downloadVendorExcel', views.downloadVendorExcel,
         name='downloadVendorExcel'),
    ...
    path('itemCategoryEdit/<int:id>',
         views.itemCategoryEdit, name='itemCategoryEdit'),
    path('itemCategoryDelete/<int:id>',
         views.itemCategoryDelete, name='itemCategoryDelete'),
    path('itemCategoryImport', views.itemCategoryImport, name='itemCategoryImport'),
    path('downloaditemCategoryExcel', views.downloaditemCategoryExcel,
         name='downloaditemCategoryExcel'),
    ...
    path('plyDimensionEdit/<int:id>',
         views.plyDimensionEdit, name='plyDimensionEdit'),
    path('plyDimensionDelete/<int:id>',
         views.plyDimensionDelete, name='plyDimensionDelete'),
    path('plyDimensionImport', views.plyDimensionImport, name='plyDimensionImport'),
    path('downloadplyDimensionExcel', views.downloadplyDimensionExcel,
         name='downloadplyDimensionExcel'),
    ...
    path('downloadstoreItemExcel', views.downloadstoreItemExcel,
         name='downloadstoreItemExcel'),
    ...
    path('purchaseOrderEdit/<int:id>',
         views.purchaseOrderEdit, name='purchaseOrderEdit'),
    path('purchaseOrderDelete/<int:id>',
         views.purchaseOrderDelete, name='purchaseOrderDelete'),
    path('purchaseOrderDetailsList/<int:header_id>',
         views.purchaseOrderDetailsList, name='purchaseOrderDetailsList'),
    ...
    path('standardTermEdit/<int:id>',
         views.standardTermEdit, name='standardTermEdit'),
    path('standardTermDelete/<int:id>',
         views.standardTermDelete, name='standardTermDelete'),

    path('storeTransactionList', views.storeTransactionList,
         name='storeTransactionList'),
    path('storeTransactionAdd', views.storeTransactionAdd,
         name='storeTransactionAdd'),
    path('storeTransactionEdit/<int:id>',
         views.storeTransactionEdit, name='storeTransactionEdit'),
    path('storeTransactionDelete/<int:id>',
         views.storeTransactionDelete, name='storeTransactionDelete'),
    path('storeTransactionDetailsList/<int:header_id>',
         views.storeTransactionDetailsList, name='storeTransactionDetailsList'),

    path('onTransitOrderList', views.onTransitOrderList, name='onTransitOrderList'),
    path('onTransitOrderDetailsList/<int:header_id>',
         views.onTransitOrderDetailsList, name='onTransitOrderDetailsList'),
    ...
    path('invoiceDetailsList/<int:header_id>',
         views.invoiceDetailsList, name='invoiceDetailsList'),
    path('printInvoice/<int:header_id>',
         views.printInvoice, name='printInvoice'),
    ...
    path('getPurchaseOrderDetails', csrf_exempt(
        views.getPurchaseOrderDetails), name='getPurchaseOrderDetails'),
    path('getTransactionType', csrf_exempt(
        views.getTransactionType), name='getTransactionType'),
    path('getInvoiceType', csrf_exempt(
        views.getInvoiceType), name='getInvoiceType'),
    path('getExceptStores', csrf_exempt(
        views.getExceptStores), name='getExceptStores'),
    path('getItemsDetailsByStore', csrf_exempt(
        views.getItemsDetailsByStore), name='getItemsDetailsByStore'),
    path('getExceptedStoreItems', csrf_exempt(
        views.getExceptedStoreItems), name='getExceptedStoreItems'),
    path('getTransferDetails', csrf_exempt(
        views.getTransferDetails), name='getTransferDetails'),
    path('getCustomerSalesOrders', csrf_exempt(
        views.getCustomerSalesOrders), name='getCustomerSalesOrders'),
    path('getSalesOrderDetails', csrf_exempt(
        views.getSalesOrderDetails), name='getSalesOrderDetails'),
    path('getItemDetails', csrf_exempt(
        views.getItemDetails), name='getItemDetails'),
